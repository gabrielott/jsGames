...
const map = [
	...
	1, 2, 5, 2, 2, 4, 2, 2, 2, 4, 2, 4, 2, 2, 2, 4, 2, 2, 5, 2, 1,
	...
	1, 2, 2, 2, 2, 4, 2, 2, 2, 3, 2, 3, 2, 2, 2, 4, 2, 2, 2, 2, 1,
	1, 1, 1, 1, 2, 4, 2, 3, 3, 3, 3, 3, 3, 3, 2, 4, 2, 1, 1, 1, 1,
	2, 2, 2, 2, 2, 4, 2, 3, 2, 2, 2, 2, 2, 3, 2, 4, 2, 2, 2, 2, 2,
	3, 3, 3, 3, 3, 4, 3, 3, 2, 3, 3, 3, 2, 3, 3, 4, 3, 3, 3, 3, 3,
	2, 2, 2, 2, 2, 4, 2, 3, 2, 2, 2, 2, 2, 3, 2, 4, 2, 2, 2, 2, 2,
	1, 1, 1, 1, 2, 4, 2, 3, 3, 3, 3, 3, 3, 3, 2, 4, 2, 1, 1, 1, 1,
	1, 2, 2, 2, 2, 4, 2, 3, 2, 2, 2, 2, 2, 3, 2, 4, 2, 2, 2, 2, 1,
	1, 2, 4, 4, 4, 4, 4, 4, 4, 4, 2, 4, 4, 4, 4, 4, 4, 4, 4, 2, 1,
	1, 2, 4, 2, 2, 4, 2, 2, 2, 4, 2, 4, 2, 2, 2, 4, 2, 2, 4, 2, 1,
	1, 2, 5, 4, 2, 4, 4, 4, 4, 4, 3, 4, 4, 4, 4, 4, 2, 4, 5, 2, 1,
...
function setup() {
	pacman = new Pacman(10, 16, Direction.north);
	key = Direction.north;
	level = 1;
	frames = SPEED;
...
function draw() {
	...
	for(let i = 0; i < MAP_WIDTH * MAP_HEIGHT; i++) {
		...
		if(map[i] === PartType.bigDot) {
			ctx.fillStyle = "white";
			ctx.arc(coord.pixelX + GRIDUNIT / 2, coord.pixelY + GRIDUNIT / 2, GRIDUNIT / 4, 0, 2 * Math.PI);
			ctx.fill();
			continue;
		}
	}
